...
sub create_menu {
	...
	$self->{_menuitem_new}->set_submenu( $self->_fct_ret_new_menu( $accel_group, $d, $gscrot_root ) );
	...
	$self->{_menuitem_pagesetup} = Gtk2::MenuItem->new_with_mnemonic( $d->get("Page Set_up") );
	...
	$self->{_menuitem_question}->set_image(
		Gtk2::Image->new_from_pixbuf(
			Gtk2::Gdk::Pixbuf->new_from_file_at_size( "$gscrot_root/share/gscrot/resources/icons/lpi-help.png", Gtk2::IconSize->lookup('menu') )
		)
	);
	...
	$self->{_menuitem_translate}->set_image(
		Gtk2::Image->new_from_pixbuf(
			Gtk2::Gdk::Pixbuf->new_from_file_at_size( "$gscrot_root/share/gscrot/resources/icons/lpi-translate.png", Gtk2::IconSize->lookup('menu') )
		)
	);
	...
	$self->{_menuitem_bug}->set_image(
		Gtk2::Image->new_from_pixbuf(
			Gtk2::Gdk::Pixbuf->new_from_file_at_size( "$gscrot_root/share/gscrot/resources/icons/lpi-bug.png", Gtk2::IconSize->lookup('menu') )
		)
	);
