...
sub create_menu {
	...
	my $gscrot_root = $self->{_common}->get_root;
	...
	$self->{_menuitem_open}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{O}, qw/control-mask/,
		qw/visible/ );
	...
	$self->{_menuitem_save_as}
		->add_accelerator( "activate", $accel_group, Gtk2::Accelerator->parse("<Shift><Control>S"),
		qw/visible/ );
	...
	$self->{_menuitem_close}
		->add_accelerator( "activate", $accel_group, Gtk2::Accelerator->parse("<Control>W"),
		qw/visible/ );
	...
	$self->{_menuitem_close_all}
		->add_accelerator( "activate", $accel_group, Gtk2::Accelerator->parse("<Shift><Control>W"),
		qw/visible/ );
	...
	$self->{_menuitem_quit}
		->add_accelerator( "activate", $accel_group, Gtk2::Accelerator->parse("<Control>Q"),
		qw/visible/ );
	...
	$self->{_menuitem_copy}
		->add_accelerator( "activate", $accel_group, Gtk2::Accelerator->parse("<Control>C"),
		qw/visible/ );
	$self->{_menu_edit}->append( $self->{_menuitem_copy} );

	$self->{_menuitem_trash}
		= Gtk2::ImageMenuItem->new_with_mnemonic( $d->get("Move to Dele_ted Items folder") );
	$self->{_menuitem_trash}
		->set_image( Gtk2::Image->new_from_icon_name( 'gnome-stock-trash', 'menu' ) );
	...
	$self->{_menuitem_settings}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{P}, qw/mod1-mask/,
		qw/visible/ );
	...
	$self->{_menuitem_selection}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{S}, qw/mod1-mask/,
		qw/visible/ );
	$self->{_menu_actions}->append( $self->{_menuitem_selection} );
	...
	$self->{_menuitem_full}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{F}, qw/mod1-mask/,
		qw/visible/ );
	$self->{_menu_actions}->append( $self->{_menuitem_full} );
	...
	$self->{_menuitem_window}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{W}, qw/mod1-mask/,
		qw/visible/ );
	$self->{_menu_actions}->append( $self->{_menuitem_window} );
	...
	$self->{_menuitem_section}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{S}, qw/shift-mask/,
		qw/visible/ );
	$self->{_menu_actions}->append( $self->{_menuitem_section} );
	...
	$self->{_menuitem_web}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{W}, qw/shift-mask/,
		qw/visible/ );
	$self->{_menu_actions}->append( $self->{_menuitem_web} );
	...
	$self->{_menuitem_back}->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{Left},
	...
	$self->{_menuitem_forward}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{Right},
		qw/mod1-mask/, qw/visible/ );
	...
	$self->{_menuitem_first}->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{Home},
		qw/mod1-mask/, qw/visible/ );
	$self->{_menu_session}->append( $self->{_menuitem_first} );

	$self->{_menuitem_last} = Gtk2::ImageMenuItem->new_from_stock('gtk-goto-last');
	$self->{_menuitem_last}->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{End},
		qw/mod1-mask/, qw/visible/ );
	...
	$self->{_menuitem_about}
		->add_accelerator( "activate", $accel_group, $Gtk2::Gdk::Keysyms{I}, qw/control-mask/,
		qw/visible/ );
