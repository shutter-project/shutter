...
sub fct_ret_file_menu {
	...
	$self->{_menuitem_pagesetup}->set_image(Gtk2::Image->new_from_icon_name('document-page-setup', 'menu'));
	...
	$self->{_menuitem_email}->set_image(Gtk2::Image->new_from_icon_name('mail-send', 'menu'));
...
sub fct_ret_help_menu {
	...
	if ($icontheme->has_icon('lpi-help')) {
		$self->{_menuitem_question}->set_image(Gtk2::Image->new_from_icon_name('lpi-help', 'menu'));
	} else {
		$self->{_menuitem_question}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/lpi-help.png", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('lpi-translate')) {
		$self->{_menuitem_translate}->set_image(Gtk2::Image->new_from_icon_name('lpi-translate', 'menu'));
	} else {
		$self->{_menuitem_translate}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/lpi-translate.png", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('lpi-bug')) {
		$self->{_menuitem_bug}->set_image(Gtk2::Image->new_from_icon_name('lpi-bug', 'menu'));
	} else {
		$self->{_menuitem_bug}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/lpi-bug.png", Gtk2::IconSize->lookup('menu'))));
	}
...
sub fct_ret_new_menu {
	...
	eval {
		...
		$self->{_menuitem_selection}->set_image(Gtk2::Image->new_from_pixbuf($ccursor_pb));
	};
	if ($@) {
		if ($icontheme->has_icon('applications-accessories')) {
			$self->{_menuitem_selection}->set_image(Gtk2::Image->new_from_icon_name('applications-accessories', 'menu'));
		} else {
			$self->{_menuitem_selection}
				->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/selection.svg", Gtk2::IconSize->lookup('menu'))));
		}
	}
	...
	if ($icontheme->has_icon('user-desktop')) {
		...
		$self->{_menuitem_full}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/desktop.svg", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('preferences-system-windows')) {
		...
		$self->{_menuitem_awindow}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/sel_window_active.svg", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('preferences-system-windows')) {
		...
		$self->{_menuitem_window}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/sel_window.svg", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('gdm-xnest')) {
		...
		$self->{_menuitem_section}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/sel_window_section.svg", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('alacarte')) {
		...
		$self->{_menuitem_menu}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/sel_window_menu.svg", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('help-faq')) {
		...
		$self->{_menuitem_tooltip}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/sel_window_tooltip.svg", Gtk2::IconSize->lookup('menu'))));
	}
	...
	if ($icontheme->has_icon('web-browser')) {
		...
		$self->{_menuitem_web}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/web_image.svg", Gtk2::IconSize->lookup('menu'))));
	}
...
sub fct_ret_actions_menu {
	...
	$self->{_menuitem_send}->set_image(Gtk2::Image->new_from_icon_name('document-send', 'menu'));
	...
	if ($icontheme->has_icon('applications-graphics')) {
		...
		$self->{_menuitem_draw}
			->set_image(Gtk2::Image->new_from_pixbuf(Gtk2::Gdk::Pixbuf->new_from_file_at_size("$shutter_root/share/shutter/resources/icons/draw.svg", Gtk2::IconSize->lookup('menu'))));
	}
...
sub fct_ret_actions_menu_large {
	...
	$self->{_menuitem_large_send}->set_image(Gtk2::Image->new_from_icon_name('document-send', 'menu'));
	$self->{_menuitem_send}->set_sensitive(FALSE);
