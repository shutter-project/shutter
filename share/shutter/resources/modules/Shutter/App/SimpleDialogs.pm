...
sub dlg_question_message {
	...
	$question_dialog->set('image' => Gtk3::Image->new_from_stock('gtk-dialog-question', 'dialog'));
...
sub dlg_error_message {
	...
	$error_dialog->set('image' => Gtk3::Image->new_from_stock('gtk-dialog-error', 'dialog'));
...
sub dlg_warning_message {
	...
	$warning_dialog->set('image' => Gtk3::Image->new_from_stock('gtk-dialog-warning', 'dialog'));
